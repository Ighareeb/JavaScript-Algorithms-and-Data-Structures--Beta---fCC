...
function buyWeapon() {
	//condition to check there are still weapons in the array to buy
...
function sellWeapon() {
	if (inventory.length > 1) {
		gold += 15;
		goldText.innerText = gold;
		//local current weapon variable not the global one
...
function attack() {
	...
	//isMonsterHit() return boolean from math.random > 0.2 || health < 20
	if (isMonsterHit()) {
		monsterHealth -=
