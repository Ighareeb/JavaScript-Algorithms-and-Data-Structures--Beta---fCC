const playlistSongs = document.getElementById('playlist-songs'); //list of songs
...
//web audio api
const audio = new Audio(); //creates new HTML audio El
//user data object, created copy of allSongs using ... so we don't mutate original when user eg. shuffling/deleting
let userData = {
	songs: [...allSongs],
...
//function to delete songs from playlist + add reset playlist button
const deleteSong = (id) => {
	...
	highlightCurrentSong();
	setPlayButtonAccessibleText();
	//check if playlist is empty --> create resetButton to reset userData object to original state
